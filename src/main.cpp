...
public:
    game_start()
    {
        symbol_int.set_rnd((int)'A', (int)'O');
...
public:
    ...
    void score_show(int temp) { cout << endl
                                     << "Step - " << temp << endl; }
...
void running_game()
{
    ...
    for (;;)
    {
        ...
        _key_detect.set_key_name();
        _key_detect.get_key_mames();

        error_key = (_key_detect.get_key_mames() == "key_error");
        escape_key = (_key_detect.get_key_mames() == "key_esc");
        restart_game = (_key_detect.get_key_mames() == "key_f1");
        ...
        else
        {
            ...
            _gaming.swap_shtick(_movment.e_motion(_key_detect.get_key_mames())->moove().sh_vert, _movment.e_motion(_key_detect.get_key_mames())->moove().sh_hori);
        }
